...
class Attendance_Faculty:##for window
    ...
    def update_data(self):
        if self.var_atten_dep.get()=="Select Department" or self.var_atten_name.get()=="" or self.var_atten_attendance.get()=="Status" or self.var_atten_dep.get()=="" or self.var_atten_time.get()=="" or self.var_atten_date.get()=="":
    ...
    def search_data(self):
        #if self.var_com_search.get()=="" or self.var_search.get()=="" or self.var_.:
