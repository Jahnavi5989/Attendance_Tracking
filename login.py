...
class Login_window:
    def __init__(self,root):
        ...
        #forgotpassword
        forgotpassbtn_admin=Button(frame_admin,text="forget Password",command=self.forgot_password_window_admin,font=("times new roman",15,"bold"),borderwidth=0,fg="black",bg="powder blue",activebackground="powder blue",activeforeground="black")
...
############################forgot password ############
    ...
    def forgot_password_window_admin(self):
         messagebox.showerror("Error","Please contact your management to reset your password")
