...
class Train_faculty:##for window
    def __init__(self,root):
        ...
        b2=Button(bg_img,text="Train faculty System",cursor="hand2",command=self.train_classifier,font=("times new roman",12,"bold"),bg="Light green",fg="white")
        b2.place(x=200,y=500,width=420,height=50)
    def train_classifier(self):
        try:
            
            data_dir=("data_faculty")
